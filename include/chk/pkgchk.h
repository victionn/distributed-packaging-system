...
//Used to store queries from different functions
struct bpkg_query {
	char** hashes;
	size_t len;
};

//Object used to store the information parsed from a bpkg file
struct bpkg_obj {
	char identifier[MAX_IDENT_SIZE + 1];
